...
void SDCardHandler::storeNewPacket(std::string filePath, Common::SDCardPackageIMUEMG& package)
{
...
void SDCardHandler::storeNewPacket(std::string filePath, Common::SDCardPackageEMG& package)
{
    File file = SD.open(filePath.c_str(), FILE_APPEND);
    if (!file)
    {
...
void SDCardHandler::storeNewPacket(std::string filePath, Common::SDCardPackageIMU& package)
{
    File file = SD.open(filePath.c_str(), FILE_APPEND);
    if (!file)
    {
